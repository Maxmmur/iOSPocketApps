...
//						break;
		...
		case DEVICE_SECTION:
			switch (indexPath.row) {
				...
				case FULLSCREEN_NOTE_ROW :
				{
					cell.textLabel.text = NSLocalizedString(@"PreferencesFullscreenNote", @"With fullscreen mode disabled, you can still switch to and from fullscreen with a 2-finger tap in the Bible and GoldenBowl tabs.");
					cell.textLabel.lineBreakMode = NSLineBreakByWordWrapping;
